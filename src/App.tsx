      ...
      <div className="app-container">
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/ambassadors" element={<div className="page-container" style={{ maxWidth: '1600px', width: '95%' }}><AmbassadorDirectory /></div>} />
            ...
            <Route path="/lab-portal" element={<div className="page-container" style={{ maxWidth: '1600px', width: '95%' }}><LabPortal /></div>} />
            <Route path="/lab-portal/printer/:id" element={<div className="page-container" style={{ maxWidth: '1600px', width: '95%' }}><PrinterDetails /></div>} />
